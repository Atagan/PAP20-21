...
object Ejercicio12 {
  def main (args:Array[String]):Unit = {
    ...
    val tam = 8
    println("Imprimimos la matriz: ")
    imprimir(lista,tam,1)
    println("¿Que elemento quieres leer? Dime la fila (empieza desde 0): ")
    val fila = readInt()
    println("¿Que elemento quieres leer? Dime la columna (empieza desde 0) : ")
    val columna = readInt()
